...
namespace PlataformaEducacao.Pagamentos.Data.Context;

public class PagamentoContext(DbContextOptions<PagamentoContext> options, IMediator mediator) : DbContext(options), IUnitOfWork
{
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfigurationsFromAssembly(typeof(PagamentoContext).Assembly);
